	...
	'page_settings' => array(
		...
		'section_1' => array(
			...
			'options' 	=> array(
                ...
                array(
                    'id'		=> 'select2_field',
                    'title'		=> __('Multi Select2  Field','text-domain'),
                    'details'	=> __('Description of multi select2 field','text-domain'),
                    'type'		=> 'select2',
                    'args'		=> array(
                        'option_1'	=> __('Option 1','text-domain'),
                        'option_2'	=> __('Option 2','text-domain'),
                ...
                array(
                    ...
                    'type'		=> 'select2',
                    'args'		=> 'WPADMINSETTINGS_TAX_%product_cat%',
                ),
...
$args = array(
    'add_in_menu'       => true,
    'menu_type'         => 'submenu',
    'menu_title'        => __( 'Sub Menu 1', 'user-profile' ),
    'page_title'        => __( 'Sub Menu Title 1', 'user-profile' ),
    'menu_page_title'   => __( 'Sub Menu Title 1', 'user-profile' ),
    'capability'        => "manage_options",
    'menu_slug'         => "submenu-1",
